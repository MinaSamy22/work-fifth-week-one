...
class _AddInternshipScreenState extends State<AddInternship> {
  ...
  File? _companyImage;
  String CompanyName = '';
  String companyId = ''; // This should be the actual company ID
  String title = '';
  String location = '';
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Generate unique internshipId
      String internshipId = Uuid().v4();
      ...
      if (adminId == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('No logged-in admin found. Please log in again.'),
      ...
      try {
        await FirebaseFirestore.instance.collection('interns').add({
          ...
          'adminId': adminId, // ✅ Save the admin ID
        });
